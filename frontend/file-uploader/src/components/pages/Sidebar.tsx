  ...
  return (
    <aside
      className={`${
        ...
        isDark ? "bg-gradient-to-b from-slate-900 to-slate-950 border-slate-800" : "bg-gradient-to-b from-slate-100 to-slate-50 border-slate-200"
      } border-r`}
    >
      ...
      <div className="p-4">
        <button 
          ...
          className={`w-full py-3 px-4 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center gap-2 group relative overflow-hidden ${
            isDark
          ...
          >
            {activeItem === item.label && (
              <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 rounded-r-full ${
                isDark ? "bg-gradient-to-b from-blue-500 to-purple-600" : "bg-gradient-to-b from-blue-500 to-purple-600"
              }`}></div>
            )}
        ...
        {isOpen ? (
          <>
            ...
            {loading ? (
              ...
              <div className="space-y-2">
                <div className={`w-full h-3 rounded-full overflow-visible ${
      ...
      <div className={`p-3 border-t ${isDark ? "border-slate-800" : "border-slate-200"}`}>
        <button
          ...
          className={`w-full py-2 px-3 rounded-lg transition-all duration-200 flex items-center justify-center ${
            isDark
