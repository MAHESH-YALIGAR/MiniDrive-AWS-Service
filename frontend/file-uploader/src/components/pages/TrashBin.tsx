...
const TrashBin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black-100-to-br from-blue-50 via-white to-red-50 p-6">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-white-600 mt-2">You can restore or permanently delete any file, including videos and photos.</p>
        </div>
